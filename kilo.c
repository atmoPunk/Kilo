...
char *C_HL_keywords[] = {
    ...
    "enum",    "class", "case",    "const",  "#define", "#include",
...
void editorMoveCursor(int key) {
    ...
    if (E.cy < E.numrows && E.savprev) {
        E.cx = editorRowRxToCx(&E.row[E.cy], E.prevrx);
    }
...
int main(int argc, char *argv[]) {
    ...
    editorSetStatusMessage("HELP: Ctrl-S = save | Ctrl-R = save as | Ctrl-Q = "
                           "quit | Ctrl-F = find");
